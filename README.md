...
- Name: Marius Cosenza
- number: F11515001
- I am a fourth-year software engineering student from Polytechnique Montréal, currently on an exchange semester here at NTUST. I previously took a general computer networking course and absolutely loved it. That experience motivated me to continue my learning journey by focusing specifically on the unique challenges and architectures of wireless communications.
...
In this lab, you will use Wireshark to analyze how a UE establishes an RRC connection with an OAI gNB and then registers with the 5G Core.
    - delivery: [Lab1 Completed](https://github.com/Marriusse/WC-2026-F11515001-Marius/blob/main/LAB1.md)
